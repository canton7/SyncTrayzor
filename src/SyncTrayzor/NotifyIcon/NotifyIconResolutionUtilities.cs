...
{
    public class NotifyIconResolutionUtilities
    {
        ...
        public static readonly DependencyProperty IconSourceProperty =
            DependencyProperty.RegisterAttached("IconSource", typeof(ImageSource), typeof(NotifyIconResolutionUtilities), new PropertyMetadata(null, (d, e) =>
            {
                ...
                SetIconFromImageSource(taskbarIcon, imageSource);
            }));
        ...
        private static int idealIconSize;

        static NotifyIconResolutionUtilities()
        {
            idealIconSize = NativeMethods.GetSystemMetrics(NativeMethods.SystemMetric.SM_CXSMICON);
        }
